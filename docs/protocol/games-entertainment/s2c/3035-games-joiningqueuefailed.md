---
title: games.joiningqueuefailed
sidebar_position: 28
---
...
- **ID**: `3035`
- **Header**: `JOININGQUEUEFAILED`
- **Direction**: Server to Client (`s2c`)
- **Realm**: Games & Entertainment
- **Phase**: `session`
- **Since**: `nitro-1.6.6`
- **Summary**: Joiningqueuefailed
...
### Sender
The server sends this message to inform the client about joiningqueuefailed state.
